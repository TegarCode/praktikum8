    ...
    <div class="container">
        <div class="card mt-5 ml-auto mr-auto">
            <div class="card-body pl-4 pr-4 pb-4">
                <img class="card-img-top" src="img/logosmartfarmerfix.png" alt="Card image" style="max-width: 350px; margin-left: 50px; ">
                <h5 class="card-title pt-3 pb-3 text-center">Registration Form</h5>
